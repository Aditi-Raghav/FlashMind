...
class ContentProcessor:
    def __init__(self):
        self.stop_words = {
            "the", "and", "for", "are", "with", "that", "this", "was", "you",
            "but", "not", "have", "from", "they", "your", "will", "can", "has",
            "had", "any", "all", "who", "when", "what", "how", "why", "been"
        }
...
4. Never add explanations or markdown"""
        ...
        try:
            ...
            print("Error during OpenRouter response:", e)
